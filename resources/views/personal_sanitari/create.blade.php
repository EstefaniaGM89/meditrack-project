...
@section('content')
    <h2 class="text-2xl font-bold mb-6">Afegir Personal Sanitari</h2>
    ...
    <form action="{{ route('personal-sanitari.store') }}" method="POST" class="space-y-4 max-w-md">
        ...
        <div>
            ...
            <input type="text" name="rol" class="w-full p-2 border rounded" placeholder="auxiliar, infermera, etc.">
        </div>
