...
@section('content')
    ...
    <h2 class="text-4xl font-extrabold tracking-tight text-indigo-800 dark:text-indigo-200 flex items-center justify-between">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Pacients -->
        <div class="p-6 rounded-2xl shadow-md border border-indigo-100 bg-indigo-50 hover:shadow-lg transition hover:scale-[1.02] duration-300">
            ...
            <a href="{{ route('pacients.index') }}" class="text-indigo-600 hover:underline mt-4 inline-block">Veure pacients</a>
        </div>

        <!-- Medicaments -->
        <div class="p-6 rounded-2xl shadow-md border border-rose-100 bg-rose-50 hover:shadow-lg transition hover:scale-[1.02] duration-300">
            <div class="flex items-center justify-between mb-2">
            ...
            <a href="{{ route('medicaments.index') }}" class="text-rose-600 hover:underline mt-4 inline-block">Veure medicaments</a>
        </div>

        <!-- Recordatoris -->
        <div class="p-6 rounded-2xl shadow-md border border-yellow-100 bg-yellow-50 hover:shadow-lg transition hover:scale-[1.02] duration-300">
            <div class="flex items-center justify-between mb-2">
            ...
            <a href="{{ route('recordatoris.index') }}" class="text-yellow-700 hover:underline mt-4 inline-block">Veure recordatoris</a>
        </div>

        <!-- Últim pacient -->
        <div class="p-6 rounded-2xl shadow-md border border-purple-100 bg-purple-50 hover:shadow-lg transition hover:scale-[1.01] duration-300 lg:col-span-2">
        ...
        <!-- Últim recordatori -->
        <div class="p-6 rounded-2xl shadow-md border border-orange-100 bg-orange-50 hover:shadow-lg transition hover:scale-[1.01] duration-300 lg:col-span-3">
